...
import {ScrollView, WebView, Text, View, Image, FlatList, Share, StyleSheet, TouchableOpacity, Linking, ActivityIndicator } from "react-native";
            ...
            <View style={css.layout.orderContent}>
              ...
              <View style={css.layout.orderID}>
                <Text style={{textAlign: "center"}}>
                  {T.orderID}{"\n"}
                  #{this.props.navigation.state.params.data.item.id}
                </Text>
              </View>
            </View>
            </View>
