...
focusMap(markers, animated) {
    ...
    var _this=this;
    setTimeout(function(){ _this.map.fitToSuppliedMarkers(markers, animated); }, 1500);
  }
    ...
    <View style={[css.layout.containerBackground,{flex:1}]}>
        ...
        {this.state.items.map(marker => (
            <Expo.MapView.Marker
                ...
                coordinate={{latitude:marker.eventLocation._lat,longitude:marker.eventLocation._long}}
