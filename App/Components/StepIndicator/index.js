    ...
    renderStep = (position) => {
      ...
      switch (this.getStepStatus(position)) {
        case STEP_STATUS.CURRENT: {
          stepStyle = {
            ...
            iconColor:this.customStyles.iconColor,
          };
        ...
        case STEP_STATUS.FINISHED:{
          stepStyle = {
            ...
            iconColor:this.customStyles.iconColorDone,
          };
      ...
      return (
        <Animated.View key={'step-indicator'}  style={[styles.step , stepStyle ]}>
          <Ionicons name={this.props.icons[position]} size={20} color={stepStyle.iconColor} />
        </Animated.View>
      );
    }
